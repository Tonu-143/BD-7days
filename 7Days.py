...
logo = '\x1b[1;97m--------------------------------------------------\n      ---> Create to by -> BD-TERMUX VIP COMMAND <--- \n\x1b[1;97m-------------------------------------------------- \n\x1b[1;97m     Facebook  -> MEHEDI HASAN TONU\x1b[00m\n\x1b[1;97m--------------------------------------------------\n    ---> Github -> TONU-143 <--- \n\x1b[1;97m--------------------------------------------------'
...
def menu():
    ...
    print '\x1b[1;91mAUTHOR  : BD-TERMUX VIP COMMAND 
    print '\x1b[1;91mFACEBOOK  : MEHEDI HASAN TONU
    print '\x1b[1;91mGITHUB  : TONU-143
    print ''
    print 50* '-'
    print '\x1b[1;94m--------------------------------------------------'
    print
    ...
    print
    print '\x1b[1;92m[1]  ROBI (BCP)'
    print '\x1b[1;92m[2]  AIRTEL(BCP)'
    print '\x1b[1;92m[3]  BANGLALINK(OLD)'
    print '\x1b[1;92m[4]  BANGLALINK(NEW)'
    print '\x1b[1;92m[5]  GRAMEEN(BCP)'
    print '\x1b[1;92m[6]  TELETALK(BCP)'
    print '\x1b[1;92m[7]  EXIT'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[BCP-CHECKPOINT]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[Login 7 Days]\x1b[0m \n'
    ...
    os.system('python2 bcp7days.py')


if __name__ == '__main__':
    menu()
# okay decompiling bcp7days.pyc
